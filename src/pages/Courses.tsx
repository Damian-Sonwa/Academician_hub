...
import { BookOpen, Lock, Users, Clock, Search, Filter, Play, CheckCircle, GraduationCap } from "lucide-react";
  ...
  if (!isAuthenticated) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-muted-foreground">Please login to view courses</p>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Discover courses across multiple subjects and start your learning journey
          </p>
        </div>
      </div>
